...
import { authenticate, isAuthenticate } from "../utli";
                ...
                <div className="w-full">
                  ...
                  <div>
                    ...
                    <input type="password" {...register("password")}
                      placeholder="Password" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" />
                  </div>
                  ...
                  <div className="mt-4 text-center">
                    <p className="text-sm">Please log in <a href="#" className="text-blue-600 hover:underline"></a></p>
                  </div>
                </div>
              </div>
            </div>
